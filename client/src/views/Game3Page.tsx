      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-3/12 bg-white/10 p-6">
          <div className="bg-black bg-opacity-10 p-5 rounded-lg h-full flex flex-col">
            <h2 className="text-xl font-silkscreen font-bold text-teal-300 mb-4 flex justify-center">
              Player
            </h2>
            <div className="h-[calc(100%-100px)] overflow-y-auto flex flex-col gap-4 scrollbar p-1">
              <div className="p-4 bg-black/20 text-white rounded-lg cursor-pointer flex items-center gap-3">
                ...
                />
                <div className="ml-3 text-2xl truncate">
            ...
            {/* Create Room Button */}
            <button className="font-silkscreen mt-4 bg-teal-500 hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded-md shadow-lg">
              Create New Room
            </button>
          </div>
        </div>
        ...
        <div className="w-9/12 bg-white/10 p-6 flex justify-center items-center">
          <div className="bg-black bg-opacity-10 p-5 rounded-lg h-full w-full flex flex-col justify-center items-center">
            <h2 className="text-xl font-silkscreen font-bold text-teal-300 mb-4">
              Game
            </h2>
            {/* Grid Content */}
              ...
              <div className="bg-gray-300/50 p-5 h-full rounded-lg">
                <div className="bg-gray-200/10 h-full flex justify-center items-end p-5">
                  <div className="flex flex-col items-center w-2/5 gap-2">
                    {/* Label */}
                    <label className="font-silkscreen text-black font-semibold">
                      Guess Here
                    </label>
                    {/* Input */}
                    <input
                      className="w-full font-silkscreen rounded-2xl p-2 text-center border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="Type here..."
                    />
                  </div>
                </div>
                <div className="mt-4">
                  <p className="text-white text-center font-silkscreen">
